...
import { emptyCart } from '../../redux/features/cart/cartSlice'; // Adjust the import path accordingly
...
const CheckoutPage = () => {
    ...
    const onSubmit = async (data) => {
        ...
        // Proceed with order creation if the cart is not empty
        const newOrder = {
            name: data.name,
        ...
        try {
            ...
            dispatch(emptyCart()); // Dispatch emptyCart to clear the cart
            Swal.fire({
